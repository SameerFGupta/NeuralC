Basic neural network written from scratch in C. It solves the classic exclusive OR problem, a basic benchmark for neural networks because it requires the network to learn nonlinear patterns.
